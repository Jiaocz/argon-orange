					<footer id="footer" class="site-footer card shadow-sm border-0">
						...
						?>
						<div>Theme&nbsp;
						  <a href="https://github.com/solstice23/argon-theme" target="_blank">
						      <strong>Argon</strong>
						  </a>
						  <?php if (get_option('argon_hide_footer_author') != 'true') {echo " By solstice23."; }?>
						  <p><a href="https://github.com/Jiaocz" target="_blank" rel="nofollow noopener">@Orangii</a> has contributed <a href="https://github.com/solstice23/argon-theme/graphs/contributors" target="_blank" rel="nofollow noopener"><strong id="contributed-commits">...</strong> commits</a> to this theme.</p>
						</div>
					</footer>
				</main>
			</div>
		...
		<script>
		    $.ajax({
		        method: 'get',
		        async: true,
		        url: 'https://api.github.com/repos/solstice23/argon-theme/contributors',
		        success: (res) => {
		            res.map(c => {
		                if(c.id == '14857984') {
		                    document.getElementById('contributed-commits').innerText = c.contributions;
		                }
		            });
		        },
		    });
